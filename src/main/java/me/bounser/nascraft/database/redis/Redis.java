...
public class Redis implements Database {
    ...
    private void startWriteScheduler() {
        ...
        try {
            int taskId = me.bounser.nascraft.managers.scheduler.SchedulerManager.getInstance().scheduleAsyncRepeating(() -> {
    ...
    public void disconnect() {
        ...
        if (flushTaskId.get() != -1) {
            try {
                me.bounser.nascraft.managers.scheduler.SchedulerManager.getInstance().cancelTask(flushTaskId.get());
            } catch (Exception e) {
