...
public interface SchedulerAdapter {
    ...
    /**
     * Schedule a one-shot async task to run after a delay.
     *
     * @param task The task to run
     * @param delayTicks Delay in ticks before execution
     * @return A task ID that can be used to cancel the task
     */
    int scheduleAsyncDelayed(Runnable task, long delayTicks);
    ...
    /**
     * Schedule a one-shot task to run on the global region after a delay.
     *
     * @param task The task to run
     * @param delayTicks Delay in ticks before execution
     * @return A task ID that can be used to cancel the task
     */
    int scheduleGlobalDelayed(Runnable task, long delayTicks);
